#include <PID_v1.h>
const int photores = A0; // entree photoresistance
const int pot = A1; // entree potentiometre
...
float Ki=10; // valeur initiale du gain intégral 
float Kd=0;  // valeur initiale du gain différentiel  
